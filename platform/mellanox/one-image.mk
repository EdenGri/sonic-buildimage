...
SONIC_IMAGE_BASE = sonic-basefs.zip
$(SONIC_IMAGE_BASE)_MACHINE = mellanox

#SONIC_BUILD_EXTENSIONS_BASE += \
    sonic_debian_extension_base \
    
SONIC_INSTALLERS_BASE += $(SONIC_IMAGE_BASE)
